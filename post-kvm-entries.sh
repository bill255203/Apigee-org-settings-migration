...
for keyvaluemap in "${keyvaluemaps[@]}"; do
  json_payload=$(cat "$DEST_DIR/keyvaluemap_${keyvaluemap_name}_entries_details.json")
  ...
  echo "$create_response" >"$DEST_DIR/keyvaluemap_${keyvaluemap_name}_entries_response.json"
